...
const JobListing = () => {
  ...
  // Check if a search has been made and if either title or location is not empty
          ...
          (searchFilter.title !== "" || searchFilter.location !== "") && (
            <>
              ...
              <div className="mb-4 text-gray-600">
                {searchFilter.title && (
                  <span className="inline-flex items-center gap-2.5 bg-blue-50 border border-blue-200 px-4 y-1.5 rounded">
                    {searchFilter.title}
                    <img
                      onClick={(e) =>
