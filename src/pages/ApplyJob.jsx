...
const ApplyJob = () => {
  ...
  return JobData ? (
    <>
      <Navbar />
      <div className="min-h-screen flex flexl-col py-10 container px-4 2xl:px-20 mx-auto">
        <div className="bg-white text-black rounded-lg w-full">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start">
            <div className="w-full lg:w-2/3">
              ...
              <div className=" rich-text w-full mt-8 lg:mt-0 space-y-5 bg-gray-100 text-lg text-gray-800 rounded-lg" 
