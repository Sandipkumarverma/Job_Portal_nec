...
const Applications = () => {
  ...
  return (
     <>
     <Navbar/>
     <div className="coantiner px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10">
        <h2 className="text-xl font-semibold">Your Resume</h2>
        <div className="flex gap-2 md-6 mt-3">
           {
            isEdit 
            ? <>
            ...
            : <div className="flex gap-2">
               ...
               {/* <button className="bg-blue-100 text-blue-600 px-4 py-2 rounded-lg">Resume</button> */}
